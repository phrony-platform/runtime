...
type HealthListResponse struct {
	state         protoimpl.MessageState                       `protogen:"open.v1"`
	Statuses      map[string]HealthCheckResponse_ServingStatus `protobuf:"bytes,1,rep,name=statuses,proto3" json:"statuses,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value,enum=grpc.health.v1.HealthCheckResponse_ServingStatus"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HealthListResponse) GetStatuses() map[string]HealthCheckResponse_ServingStatus {
	if x != nil {
		return x.Statuses
	}
	return nil
...
const file_grpc_health_v1_health_proto_rawDesc = "" +
	...
	"\x11HealthListRequest\"\xd2\x01\n" +
	"\x12HealthListResponse\x12L\n" +
	"\bstatuses\x18\x01 \x03(\v20.grpc.health.v1.HealthListResponse.StatusesEntryR\bstatuses\x1an\n" +
	"\rStatusesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12G\n" +
	"\x05value\x18\x02 \x01(\x0e21.grpc.health.v1.HealthCheckResponse.ServingStatusR\x05value:\x028\x012\xfd\x01\n" +
	"\x06Health\x12P\n" +
	...
	"\x05Watch\x12\".grpc.health.v1.HealthCheckRequest\x1a#.grpc.health.v1.HealthCheckResponse0\x01BFZDgithub.com/phrony-platform/runtime/gen/grpc/health/v1;grpc_health_v1b\x06proto3"
...
var file_grpc_health_v1_health_proto_depIdxs = []int32{
	...
	0, // 2: grpc.health.v1.HealthListResponse.StatusesEntry.value:type_name -> grpc.health.v1.HealthCheckResponse.ServingStatus
